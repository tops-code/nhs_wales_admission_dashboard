...
## health boards and areas served
  health_board <- c(
...
#create function to get data from files
...
- Year: NHS financial year (April 1 – March 31 2023).
...
📌 **Admissions (Admission Episodes)**:

First episode in a patient’s spell of care.
...
- Calculated from admission → discharge.
